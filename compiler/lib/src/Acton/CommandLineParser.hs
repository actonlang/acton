...
cmdLineParser       = hsubparser
                        ...
                        <> command "artifact" (info (CmdOpt <$> globalOptions <*> (Artifact <$> artifactSubcommands)) (progDesc "Build or publish Acton output artifacts"))
...
artifactSubcommands :: Parser ArtifactCommand
artifactSubcommands = hsubparser
  (  command "pack" (info (ArtifactPack <$> artifactPackOptions) (progDesc "Pack out/types as an Acton artifact"))
  <> command "push" (info (ArtifactPush <$> artifactPushOptions) (progDesc "Pack and push an Acton artifact to OCI"))
  <> command "hash" (info (ArtifactHash <$> artifactHashOptions) (progDesc "Compute the Acton package source hash for a local path"))
  )
