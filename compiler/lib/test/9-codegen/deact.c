...
$R deactQ_U_L_5C_3cont ($Cont C_cont, int64_t U_3C_4res) {
    return $R_CONT(C_cont, B_None);
}
$R deactQ_L_5C_3cont ($Cont C_cont, B_int C_4res) {
    return deactQ_U_L_5C_3cont(C_cont, ((B_int)C_4res)->val);
}
...
$R deactQ_U_1L_7C_5cont ($action cb, $Cont C_cont, int64_t U_4C_6res) {
...
$R deactQ_L_7C_5cont ($action cb, $Cont C_cont, B_int C_6res) {
    return deactQ_U_1L_7C_5cont(cb, C_cont, ((B_int)C_6res)->val);
}
...
$R deactQ_L_11procD___call__ (deactQ_L_11proc L_self, $Cont C_cont) {
    ...
    return (($R (*) (deactQ_Apa, $Cont, B_int))self->$class->noticeG_local)(self, C_cont, toB_int(U_7i));
}
...
$R deactQ_L_12procD___call__ (deactQ_L_12proc L_self, $Cont C_cont) {
    ...
    return (($R (*) (deactQ_Bepa, $Cont, B_int))self->$class->callbackG_local)(self, C_cont, toB_int(U_8i));
}
...
$R deactQ_U_2L_19C_11cont (deactQ_main self, $Cont C_cont, int64_t U_9C_12res) {
...
$R deactQ_L_19C_11cont (deactQ_main self, $Cont C_cont, B_int C_12res) {
    return deactQ_U_2L_19C_11cont(self, C_cont, ((B_int)C_12res)->val);
}
...
$R deactQ_L_25procD___call__ (deactQ_L_25proc L_self, $Cont C_cont) {
    deactQ_main self = L_self->self;
    int64_t U_10i = ((B_int)L_self->i)->val;
    return (($R (*) (deactQ_main, $Cont, B_int))self->$class->myprocG_local)(self, C_cont, toB_int(U_10i));
}
...
$R deactQ_ApaD_setupG_local (deactQ_Apa self, $Cont C_cont, $proc cb) {
    ...
    return (($R (*) ($proc, B_value, B_int))cb->$class->__exec__)(cb, ((B_value)deactQ_L_6ContG_new(C_cont)), toB_int(0LL));
}
...
$R deactQ_ApaD_computeG_local (deactQ_Apa self, $Cont C_cont, $action cb) {
    ...
    return $AWAIT((($Cont)deactQ_L_8ContG_new(cb, C_cont)), ((B_Msg)((B_Msg (*) ($action, B_int))cb->$class->__asyn__)(cb, toB_int(1LL))));
}
...
$R deactQ_ApaD_noticeG_local (deactQ_Apa self, $Cont C_cont, B_int i) {
    ...
    int64_t U_11N_1tmp = (((B_int)i)->val + 1LL);
    return $R_CONT(C_cont, toB_int(U_11N_1tmp));
}
...
$R deactQ_BepaD_callbackG_local (deactQ_Bepa self, $Cont C_cont, B_int i) {
    ...
    int64_t U_12N_2tmp = (((B_int)i)->val + 1LL);
    return $R_CONT(C_cont, toB_int(U_12N_2tmp));
}
