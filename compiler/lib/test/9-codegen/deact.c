...
$R deactQ_L_4actionD___call__ (deactQ_L_4action L_self, $Cont L_cont, B_bigint G_1) {
    return $AWAIT(L_cont, ((B_Msg)((B_Msg (*) (deactQ_L_4action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
$R deactQ_L_4actionD___exec__ (deactQ_L_4action L_self, $Cont L_cont, B_bigint G_1) {
    return $R_CONT(L_cont, ((B_value)((B_Msg (*) (deactQ_L_4action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
B_Msg deactQ_L_4actionD___asyn__ (deactQ_L_4action L_self, B_bigint G_1) {
    deactQ_Apa L_3obj = L_self->L_3obj;
    return ((B_Msg)((B_Msg (*) (deactQ_Apa, B_bigint))L_3obj->$class->notice)(L_3obj, G_1));
}
...
$R deactQ_L_5C_3cont ($action cb, $Cont C_cont, B_bigint C_4res) {
    ...
    B_bigint N_tmp = ((B_bigint (*) (B_Times, B_bigint, B_bigint))deactQ_W_223->$class->__mul__)(deactQ_W_223, v, ((B_bigint)toB_bigint(10UL)));
...
$R deactQ_L_6ContD___call__ (deactQ_L_6Cont L_self, B_bigint G_1) {
    $action cb = L_self->cb;
    $Cont C_cont = L_self->C_cont;
...
B_NoneType deactQ_L_9procD___init__ (deactQ_L_9proc L_self, deactQ_Apa self, B_bigint i) {
    L_self->self = self;
    L_self->i = i;
    return B_None;
}
$R deactQ_L_9procD___call__ (deactQ_L_9proc L_self, $Cont C_cont) {
    deactQ_Apa self = L_self->self;
    B_bigint i = L_self->i;
    return (($R (*) (deactQ_Apa, $Cont, B_bigint))self->$class->noticeG_local)(self, C_cont, i);
}
...
deactQ_L_9proc deactQ_L_9procG_new(deactQ_Apa G_1, B_bigint G_2) {
...
B_NoneType deactQ_L_10procD___init__ (deactQ_L_10proc L_self, deactQ_Bepa self, B_bigint i) {
    L_self->self = self;
    L_self->i = i;
    return B_None;
}
$R deactQ_L_10procD___call__ (deactQ_L_10proc L_self, $Cont C_cont) {
    ...
    B_bigint i = L_self->i;
    return (($R (*) (deactQ_Bepa, $Cont, B_bigint))self->$class->callbackG_local)(self, C_cont, i);
}
...
deactQ_L_10proc deactQ_L_10procG_new(deactQ_Bepa G_1, B_bigint G_2) {
...
$R deactQ_L_14actionD___call__ (deactQ_L_14action L_self, $Cont L_cont, B_bigint G_1) {
    return $AWAIT(L_cont, ((B_Msg)((B_Msg (*) (deactQ_L_14action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
$R deactQ_L_14actionD___exec__ (deactQ_L_14action L_self, $Cont L_cont, B_bigint G_1) {
    return $R_CONT(L_cont, ((B_value)((B_Msg (*) (deactQ_L_14action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
B_Msg deactQ_L_14actionD___asyn__ (deactQ_L_14action L_self, B_bigint G_1) {
    deactQ_Apa L_13obj = L_self->L_13obj;
    return ((B_Msg)((B_Msg (*) (deactQ_Apa, B_bigint))L_13obj->$class->notice)(L_13obj, G_1));
}
...
$R deactQ_L_16actionD___call__ (deactQ_L_16action L_self, $Cont L_cont, B_bigint G_1) {
    return $AWAIT(L_cont, ((B_Msg)((B_Msg (*) (deactQ_L_16action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
$R deactQ_L_16actionD___exec__ (deactQ_L_16action L_self, $Cont L_cont, B_bigint G_1) {
    return $R_CONT(L_cont, ((B_value)((B_Msg (*) (deactQ_L_16action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
B_Msg deactQ_L_16actionD___asyn__ (deactQ_L_16action L_self, B_bigint G_1) {
    deactQ_Bepa L_15obj = L_self->L_15obj;
    return ((B_Msg)((B_Msg (*) (deactQ_Bepa, B_bigint))L_15obj->$class->callback)(L_15obj, G_1));
}
...
$R deactQ_L_19actionD___call__ (deactQ_L_19action L_self, $Cont L_cont, B_bigint G_1) {
    return $AWAIT(L_cont, ((B_Msg)((B_Msg (*) (deactQ_L_19action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
$R deactQ_L_19actionD___exec__ (deactQ_L_19action L_self, $Cont L_cont, B_bigint G_1) {
    return $R_CONT(L_cont, ((B_value)((B_Msg (*) (deactQ_L_19action, B_bigint))L_self->$class->__asyn__)(L_self, G_1)));
}
B_Msg deactQ_L_19actionD___asyn__ (deactQ_L_19action L_self, B_bigint G_1) {
    deactQ_main L_18obj = L_self->L_18obj;
    return ((B_Msg)((B_Msg (*) (deactQ_main, B_bigint))L_18obj->$class->myproc)(L_18obj, G_1));
}
...
$R deactQ_L_17C_9cont (deactQ_main self, $Cont C_cont, B_bigint C_10res) {
...
$R deactQ_L_20ContD___call__ (deactQ_L_20Cont L_self, B_bigint G_1) {
...
B_NoneType deactQ_L_23procD___init__ (deactQ_L_23proc L_self, deactQ_main self, B_bigint i) {
    L_self->self = self;
    L_self->i = i;
    return B_None;
}
$R deactQ_L_23procD___call__ (deactQ_L_23proc L_self, $Cont C_cont) {
    deactQ_main self = L_self->self;
    B_bigint i = L_self->i;
    return (($R (*) (deactQ_main, $Cont, B_bigint))self->$class->myprocG_local)(self, C_cont, i);
}
...
deactQ_L_23proc deactQ_L_23procG_new(deactQ_main G_1, B_bigint G_2) {
...
$R deactQ_ApaD_computeG_local (deactQ_Apa self, $Cont C_cont, $action cb) {
    ...
    return $AWAIT((($Cont)deactQ_L_6ContG_new(cb, C_cont)), ((B_Msg)((B_Msg (*) ($action, B_bigint))cb->$class->__asyn__)(cb, ((B_bigint)toB_bigint(1UL)))));
}
#line 10 "test/src/deact.act"
$R deactQ_ApaD_noticeG_local (deactQ_Apa self, $Cont C_cont, B_bigint i) {
    ...
    B_bigint N_1tmp = ((B_bigint (*) (B_Plus, B_bigint, B_bigint))deactQ_W_586->$class->__add__)(deactQ_W_586, i, ((B_bigint)toB_bigint(1UL)));
...
B_Msg deactQ_ApaD_notice (deactQ_Apa self, B_bigint i) {
...
$R deactQ_BepaD_callbackG_local (deactQ_Bepa self, $Cont C_cont, B_bigint i) {
    ...
    B_bigint N_2tmp = ((B_bigint (*) (B_Plus, B_bigint, B_bigint))deactQ_W_586->$class->__add__)(deactQ_W_586, i, ((B_bigint)toB_bigint(1UL)));
    return $R_CONT(C_cont, N_2tmp);
}
B_Msg deactQ_BepaD_callback (deactQ_Bepa self, B_bigint i) {
...
$R deactQ_mainD_myprocG_local (deactQ_main self, $Cont C_cont, B_bigint i) {
...
B_Msg deactQ_mainD_myproc (deactQ_main self, B_bigint i) {
...
void deactQ___init__ () {
    ...
    B_Times W_223 = (B_Times)B_IntegralD_bigintG_witness;
    deactQ_W_223 = W_223;
    B_Plus W_586 = (B_Plus)B_IntegralD_bigintG_witness;
    deactQ_W_586 = W_586;
    B_Eq W_761 = (B_Eq)B_OrdD_bigintG_witness;
    deactQ_W_761 = W_761;
}