...
void intsQ___init__ () {
    ...
    B_bigint bigint_small = ((B_bigint (*) (B_IntegralD_bigint, B_atom))B_IntegralD_bigintD___fromatom__)((B_IntegralD_bigint)B_IntegralD_bigintG_witness, ((B_atom)toB_int(42LL)));
    intsQ_bigint_small = bigint_small;
    B_bigint bigint_neg_small = ((B_bigint (*) (B_IntegralD_bigint, B_atom))B_IntegralD_bigintD___fromatom__)((B_IntegralD_bigint)B_IntegralD_bigintG_witness, ((B_atom)toB_int(-1LL)));
    intsQ_bigint_neg_small = bigint_neg_small;
    B_bigint bigint_i64_max = ((B_bigint (*) (B_IntegralD_bigint, B_atom))B_IntegralD_bigintD___fromatom__)((B_IntegralD_bigint)B_IntegralD_bigintG_witness, ((B_atom)toB_int(9223372036854775807LL)));
    intsQ_bigint_i64_max = bigint_i64_max;
    B_bigint bigint_i64_min = ((B_bigint (*) (B_IntegralD_bigint, B_atom))B_IntegralD_bigintD___fromatom__)((B_IntegralD_bigint)B_IntegralD_bigintG_witness, ((B_atom)toB_int((-9223372036854775807LL - 1LL))));
