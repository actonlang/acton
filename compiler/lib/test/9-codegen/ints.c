...
void intsQ___init__ () {
    ...
    intsQ_W_20 = W_20;
    B_i8 int8_min = ((B_i8 (*) (B_Number, B_atom))intsQ_W_20->$class->__fromatom__)(intsQ_W_20, ((B_atom)toB_bigint(-128UL)));
    ...
    B_bigint bigint_neg_small = ((B_bigint)toB_bigint(-1UL));
    ...
    B_bigint bigint_i64_min = ((B_bigint)toB_bigint(-1337UL));
    intsQ_bigint_i64_min = bigint_i64_min;
    B_bigint bigint_i64_underflow = ((B_bigint)toB_bigint(-1337UL));
