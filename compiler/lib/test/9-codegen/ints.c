...
B_Number intsQ_W_bigint_small_2;
B_bigint intsQ_bigint_small;
B_Number intsQ_W_bigint_neg_small_2;
B_bigint intsQ_bigint_neg_small;
B_Number intsQ_W_bigint_i64_max_2;
B_bigint intsQ_bigint_i64_max;
B_Number intsQ_W_bigint_i64_min_2;
...
void intsQ___init__ () {
    ...
    B_bigint bigint_small = ((B_bigint (*) ($WORD, B_atom))((B_Number)(intsQ_W_bigint_small_2))->$class->__fromatom__)(intsQ_W_bigint_small_2, ((B_atom)toB_bigint(42UL)));
    intsQ_bigint_small = bigint_small;
    B_Number W_bigint_neg_small_2 = (B_Number)B_IntegralD_bigintG_witness;
    intsQ_W_bigint_neg_small_2 = W_bigint_neg_small_2;
    B_bigint bigint_neg_small = ((B_bigint (*) ($WORD, B_atom))((B_Number)(intsQ_W_bigint_neg_small_2))->$class->__fromatom__)(intsQ_W_bigint_neg_small_2, ((B_atom)toB_bigint2("-1")));
    intsQ_bigint_neg_small = bigint_neg_small;
    B_Number W_bigint_i64_max_2 = (B_Number)B_IntegralD_bigintG_witness;
    intsQ_W_bigint_i64_max_2 = W_bigint_i64_max_2;
    B_bigint bigint_i64_max = ((B_bigint (*) ($WORD, B_atom))((B_Number)(intsQ_W_bigint_i64_max_2))->$class->__fromatom__)(intsQ_W_bigint_i64_max_2, ((B_atom)toB_bigint(9223372036854775807UL)));
    intsQ_bigint_i64_max = bigint_i64_max;
    B_Number W_bigint_i64_min_2 = (B_Number)B_IntegralD_bigintG_witness;
    intsQ_W_bigint_i64_min_2 = W_bigint_i64_min_2;
    B_bigint bigint_i64_min = ((B_bigint (*) ($WORD, B_atom))((B_Number)(intsQ_W_bigint_i64_min_2))->$class->__fromatom__)(intsQ_W_bigint_i64_min_2, ((B_atom)toB_bigint2("-9223372036854775808")));
