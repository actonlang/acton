...
client$$l$1lambda client$$l$1lambda$new(minienv$$Connection C$1par, client$$client C$2par) {
    client$$l$1lambda $tmp = malloc(sizeof(struct client$$l$1lambda));
    $tmp->$class = &client$$l$1lambda$methods;
    client$$l$1lambda$methods.__init__($tmp, C$1par, C$2par);
    return $tmp;
}
...
$Msg client$$l$2lambda$__call__ (client$$l$2lambda l$self, minienv$$Connection t$y) {
    client$$client __self__ = l$self->__self__;
    return $ASYNC(($Actor)__self__, ($Cont)client$$l$1lambda$new(t$y, __self__));
}
client$$l$2lambda client$$l$2lambda$new(client$$client C$1par) {
    client$$l$2lambda $tmp = malloc(sizeof(struct client$$l$2lambda));
    $tmp->$class = &client$$l$2lambda$methods;
    client$$l$2lambda$methods.__init__($tmp, C$1par);
    return $tmp;
}
...
client$$l$4lambda client$$l$4lambda$new(minienv$$Env C$1par) {
    client$$l$4lambda $tmp = malloc(sizeof(struct client$$l$4lambda));
    $tmp->$class = &client$$l$4lambda$methods;
    client$$l$4lambda$methods.__init__($tmp, C$1par);
    return $tmp;
}
...
client$$l$6lambda client$$l$6lambda$new(minienv$$Env C$1par) {
    client$$l$6lambda $tmp = malloc(sizeof(struct client$$l$6lambda));
    $tmp->$class = &client$$l$6lambda$methods;
    client$$l$6lambda$methods.__init__($tmp, C$1par);
    return $tmp;
}
...
client$$l$8lambda client$$l$8lambda$new(minienv$$Connection C$1par) {
    client$$l$8lambda $tmp = malloc(sizeof(struct client$$l$8lambda));
    $tmp->$class = &client$$l$8lambda$methods;
    client$$l$8lambda$methods.__init__($tmp, C$1par);
    return $tmp;
}
...
client$$l$9lambda client$$l$9lambda$new(client$$client C$1par, minienv$$Connection C$2par) {
    client$$l$9lambda $tmp = malloc(sizeof(struct client$$l$9lambda));
    $tmp->$class = &client$$l$9lambda$methods;
    client$$l$9lambda$methods.__init__($tmp, C$1par, C$2par);
    return $tmp;
}
...
$R client$$client$__init__ (client$$client __self__, minienv$$Env env, $Cont c$cont) {
    __self__->env = env;
    $Number w$63 = ($Number)$Integral$int$new();
    __self__->env->$class->connect(__self__->env, to$str("localhost"), w$63->$class->__fromatom__(w$63, to$int(12345)), ($function)client$$l$2lambda$new(__self__));
    return $R_CONT(c$cont, $None);
}
$R client$$client$session$local (client$$client __self__, minienv$$Connection conn, $Cont c$cont) {
    conn->$class->on_receipt(conn, ($function)client$$l$4lambda$new(__self__->env), ($function)client$$l$6lambda$new(__self__->env));
    __self__->env->$class->stdin_install(__self__->env, ($function)client$$l$8lambda$new(conn));
    return $R_CONT(c$cont, $None);
}
$Msg client$$client$session (client$$client __self__, minienv$$Connection conn) {
    return $ASYNC(($Actor)__self__, ($Cont)client$$l$9lambda$new(__self__, conn));
}
$R client$$client$new(minienv$$Env C$1par, $Cont C$2par) {
    client$$client $tmp = malloc(sizeof(struct client$$client));
    $tmp->$class = &client$$client$methods;
    return client$$client$methods.__init__($tmp, C$1par, $CONSTCONT($tmp, C$2par));
}
