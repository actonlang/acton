...
Use `build_options` in `Build.act` to configure application builds, including
garbage collector tuning. See [Application build options](compilation/build_options.md)
for the available settings and how they apply to dependencies.
