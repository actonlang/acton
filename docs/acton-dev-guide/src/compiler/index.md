...
header (`.ty`), and compute interface hashes used for incremental rebuilds. They
...
finish before invoking Zig; the LSP typically only runs front passes and defers
back passes.
