...
//
// $ASYNC allocates one of each and links them via env->$fut. After envelopes
// carry no future ("after" is a statement; its value cannot be bound).
