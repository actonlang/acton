...
$None $dict_serialize($dict, $Mapping$dict, $WORD*, int, $dict, $ROWLISTHEADER);
$dict $dict_deserialize($Mapping$dict, $ROW*, $dict);


struct  $Mapping$dict$class $Mapping$dict$methods = {"",$Mapping$dict$__iter__, $Mapping$dict$__fromiter__, $Mapping$dict$__len__, $Mapping$dict$__contains__,
...
struct $Indexed$dict$class   $Indexed$dict$methods = {"", $Indexed$dict$__getitem__, $Indexed$dict$__setitem__, $Indexed$dict$__delitem__};
