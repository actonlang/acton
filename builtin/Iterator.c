...
struct $Iterable$Iterator$class $Iterable$Iterator$methods = {"", UNASSIGNED,NULL, (void (*)($Iterable$Iterator))$default__init__,$Iterable$Iterator__iter__};
...
struct $Iterator$class $Iterator$methods = {"",UNASSIGNED,NULL,NULL,NULL,NULL,NULL}; // $Iterator is an abstract class
