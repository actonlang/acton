...
struct $Set$set$class $Set$set$methods = {"", NULL, $Set$set$__init__,$Set$set$__iter__, $Set$set$__fromiter__, $Set$set$__len__, $Set$set$__contains__,
                                                   $Set$set$__containsnot__, $Set$set$isdisjoint, $Set$set$add, $Set$set$discard, $Set$set$pop};   

struct $Ord$set$class $Ord$set$methods = {"", NULL, $Ord$set$__init__,$Ord$set$__eq__,$Ord$set$__ne__,$Ord$set$__lt__,$Ord$set$__le__,$Ord$set$__gt__,$Ord$set$__ge__};

struct $Minus$set$class $Minus$set$methods = {"", NULL, $Minus$set$__init__,$Minus$set$__sub__};

struct $Logical$set$class $Logical$set$methods = {"", NULL, $Logical$set$__init__,$Logical$set$__and__,$Logical$set$__or__,$Logical$set$__xor__};
...
$set $Set$set$__fromiter__ ($Set$set wit, $Iterable$opaque it) {
  return $set_fromiter(wit->w$Hashable$Set,it);
}
